...
const toggleColorClass = computed(() => {
  ...
  if (name.includes('pi') || name.includes('plaque')) return 'bg-blue-500 shadow-inner'
...
const containerClasses = computed(() => ({
  ...
  'ring-1 ring-inset ring-red-400 bg-red-50/50': props.validationState === 'invalid',
